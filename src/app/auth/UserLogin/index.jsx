            ...
            <div className='w-full lg:w-1/2 p-8 h-full flex flex-col'>
                ...
                {isForgotPasswordClicked ?
                    <div className='flex flex-col gap-4 mt-10 mx-auto w-5/6'>
                        ...
                        <Button 
                            label={sendingPassword ? 'Sending password...' : passwordSend ? 'Password sent to your email' : 'Send password'} 
                            type='btn-primary' 
                    ...
                    : <div className='flex flex-col gap-4 mt-10 mx-auto w-5/6'>
                        ...
                        <Button 
                            label={sendingPassword ? 'Sending password...' : passwordSend ? 'Password sent to your email' : 'Forgot password?'} 
                            type='btn-tertiary' 
